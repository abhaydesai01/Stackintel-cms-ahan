$(document).ready(function () {
	...
	$(".faq .faq-item .faq-title").click(function () {
		...
		if (item.hasClass("active")) $(this).find(".fa").removeClass("fa-angle-up").addClass("fa-angle-down"); else $(this).find(".fa").removeClass("fa-angle-down").addClass("fa-angle-up");
	...
	$("#faqForm").on("submit", function () {
		...
		} else $("#faqSearchResult").html("<span class='text-error'>Minimum 3 chars required</span>");
